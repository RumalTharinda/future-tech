...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id WHERE order_status='approved' AND tbl_customer.customer_first_name LIKE '%$search%' OR tbl_oder.order_date LIKE '%$search%' OR tbl_customer.customer_last_name LIKE '%$search%'";
} else {
    // Default query to fetch all stock items
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id WHERE order_status='approved'";
}
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td><?= $row['order_status'] ?></td>
                                             ...
                                             <td>
                                                <form method="post" action="approved_manage.php?order_id=<?= $row['order_id'] ?>" class="row g-3" novalidate>
