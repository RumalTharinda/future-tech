...
<main id="main" class="main">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$action == 'approved') {
        $db = dbconn();
        $sql = "UPDATE tbl_oder SET order_status='delivered' WHERE order_id='$order_id'";
        $db->query($sql);
 ...
 <div class="card">
    ...
    <section class="section">
        ...
        <section>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Manage delivery</h5> 

                    <div class="d-grid gap-2 col-6 mx-auto">

                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate>
                            <input type="hidden" name="order_id" value="<?= $order_id ?>"> 
                            <button class="btn btn-primary btn-block col-12" type="submit" name="action" value="approved">delivered <span class="bi bi-truck"></span></button>
                        </form>
