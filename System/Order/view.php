...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id WHERE tbl_customer.customer_first_name LIKE '%$search%' OR tbl_oder.order_date LIKE '%$search%' OR tbl_customer.customer_last_name LIKE '%$search%'";
} else {
    // Default query to fetch all stock items
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id";
}
