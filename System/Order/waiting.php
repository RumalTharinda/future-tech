...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id WHERE order_status='waiting' AND tbl_customer.customer_first_name LIKE '%$search%' OR tbl_oder.order_date LIKE '%$search%' OR tbl_customer.customer_last_name LIKE '%$search%'";
} else {
    // Default query to fetch all stock items
    $sql = "SELECT * FROM tbl_oder LEFT JOIN tbl_customer ON tbl_customer.customer_id=tbl_oder.customer_id WHERE order_status='waiting'";
}
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= SYSTEM_PATH ?>index.php">Order</a></li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Exciting Waiting Order</h5>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td><?= $row['order_status'] ?></td>
                                             ...
                                             <td>
                                                <form method="post" action="order_billiing_info.php?order_id=<?= $row['order_id'] ?>" class="row g-3" novalidate>
