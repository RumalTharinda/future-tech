...
<main id="main" class="main">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$action == 'save') {
        ...
        if (empty($message)) {
            $db = dbconn();
            $sql = "INSERT INTO tbl_banner(img_file)VALUES('$file_name_new')";
            $db->query($sql);
        }
    }
    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Exciting Banners</h5>
                        ...
                        <table class="table datatable datatable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" style="width: 20%;">Banner ID</th>
                                    <th data-sortable="true" style="width: 18%;">Banner</th>                                   
