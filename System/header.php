...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicons -->
        <link href="<?= SYSTEM_PATH ?>assets\img\future-tech\Logo.jpg" rel="icon">
        <link href="<?= SYSTEM_PATH ?>assets\img\future-tech\Logo.jpg" rel="apple-touch-icon">
    ...
    <body>
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= SYSTEM_PATH ?>index.php" class="logo d-flex align-items-center">
                    <img src="<?= SYSTEM_PATH ?>assets\img\future-tech\Logo.jpg" alt="">
                ...
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $_SESSION['FNAME']; ?></span>
                        </a><!-- End Profile Iamge Icon -->

                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li class="dropdown-header">
                                <h6><?php echo $_SESSION['FNAME']; ?></h6>
                                <span><?php echo $_SESSION['JOBTITLE']; ?></span>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="<?= SYSTEM_PATH ?>NeedHelp.php">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="<?= SYSTEM_PATH ?>logout.php">
