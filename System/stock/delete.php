                        ...
                        <table class="table datatable datatable-table">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" style="width: 20.77372262773723%;">Stock Purchase Date</th>
                                    <th data-sortable="true" style="width: 10.77372262773723%;">Stock Unit Price (Rs)</th>
                                    <th data-sortable="true" style="width: 9.306569343065693%;">Stock Quantity</th>
                                    <th data-sortable="true" style="width: 9.306569343065693%;">Stock Sale Price (Rs)</th>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr data-index="0">
                                            ...
                                            <td><?= $row['stock_unite_price'] ?></td>
                                            <td><?= $row['stock_quantity'] ?></td>
                                            <td><?= $row['stock_sale_price'] ?></td>
                        ...
                        <table class="table datatable datatable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="true" style="width: 34.919708029197082%;">Product Name</th>
                                    <th data-sortable="true" style="width: 20.77372262773723%;">Stock purchase date</th>
                                    <th data-sortable="true" style="width: 10.77372262773723%;">Stock unite price Rs:</th>
                                    <th data-sortable="true" style="width: 9.306569343065693%;">Stock quantity</th>
                                    <th data-sortable="true" style="width: 9.306569343065693%;">Stock sale price Rs:</th>
                                    <th data-sortable="true" aria-sort="descending" class="datatable-descending" style="width: 10.34306569343066%;">Stock Discount %</th>
                                </tr>
