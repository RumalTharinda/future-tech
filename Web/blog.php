                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="blog__sidebar">
                            ...
                            <div class="blog__sidebar__item">
                                <h4>Categories</h4>
                                <ul>
                                    <li><a style="color: black;" href="blog.php">All</a></li>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <li><a href="blog.php?categories_id=<?= $row['categories_id'] ?>"><?= $row['categories_name'] ?></a></li>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="row">
                            ...
                            if (!empty(@$categories_id)) {
                                $where = " WHERE tbl_product.product_categories='$categories_id'";
                            }
                            ...
                            if (isset($_GET['search'])) {
                                ...
                                $sql = "SELECT * FROM tbl_blog LEFT JOIN tbl_product ON tbl_product.product_id=tbl_blog.product_id $where";
                            }
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="blog__item">
                                            <div class="blog__item__pic">
                                                <img src="../System/Product/img/<?= $row['product_img'] ?>" alt="">
                                            </div>
