...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$operate == 'update') {
    ...
    $_SESSION['cart'][$stock_id]['product_qty']=$qty;
                    ...
                    <div class="col-lg-12">
                        <div class="shoping__cart__table">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="shoping__product" style="width: 40%;">Products</th>
                                        ...
                                        foreach ($_SESSION['cart'] as $key => $value) {
                                            ...
                                            <tr>
                                                <td class="shoping__cart__item">
                                                    <img width="75" src="../System/Product/img/<?= $value['product_img'] ?>" alt="">
                                                    <h5><?= $value['product_name'] ?></h5>
                                                </td>

                                                <td class="shoping__cart__price">
                                                    Rs:<?= number_format($value['product_price'], 2) ?>
                                                ...
                                                <td>
                                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate >
                                                                ...
                                                                <select onchange="form.submit()"  name="qty">
                                                                    <option value="1" <?php
                                                                    ...
                                                                    ?>>1</option>
                                                                    <option value="2" <?php
                                                                    if ($value['product_qty'] == '2') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>2</option>
                                                                    <option value="3" <?php
                                                                    if ($value['product_qty'] == '3') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>3</option>
                                                                    <option value="4" <?php
                                                                    if ($value['product_qty'] == '4') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>4</option>
                                                                    <option value="5" <?php
                                                                    ...
                                                                    ?>>5</option>
                                                                    <option value="6" <?php
                                                                    if ($value['product_qty'] == '6') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>6</option>
                                                                    <option value="7" <?php
                                                                    if ($value['product_qty'] == '7') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>7</option>
                                                                    <option value="8" <?php
                                                                    if ($value['product_qty'] == '8') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>8</option>
                                                                    <option value="9" <?php
                                                                    if ($value['product_qty'] == '9') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>9</option>
                                                                    <option value="10" <?php
                                                                    if ($value['product_qty'] == '10') {
                                                                        echo 'selected';
                                                                    }
                                                                    ?>>10</option>
                                                                </select>
                                                ...
                                                <td class="shoping__cart__total">
                                                    Rs:<?= number_format($discount = ($value['product_price'] * $value['product_qty']) * ($value['product_discount'] / 100), 2) ?>(<?= $value['product_discount'] ?>%)
                                                </td>

                                                <td class="shoping__cart__total">                                       
                                                    Rs:<?= number_format($value['product_price'] * $value['product_qty'] - $discount, 2) ?>
                                                </td>

                                                <td class="shoping__cart__item__close">
                                                   <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" novalidate >
                                                       <button type="submit" name="operate" value="delete"> <span class="icon_close"></span></button>
                                                       <input  type="hidden" name="stock_id" value="<?= $key ?>">
                                                   </form>
                                                </td>
                                            </tr>
