                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                        <div class="contact__widget">
                            ...
                            <h4>Address</h4>
                            <p>128 Dr NM Perera Mawatha Rd, Colombo 00800</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                        <div class="contact__widget">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                        <div class="contact__widget">
                            ...
                            <h4>Email</h4>
                            <p>future.tech.colombo@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="map-inside">
                ...
                <div class="inside-widget">
                    ...
                    <ul>
                        ...
                        <li>Add: 128 Dr NM Perera Mawatha Rd, Colombo 00800</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="contact-form spad">
            <div class="container">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $messagepass = dataclean($messagepass);
                    ...
                    if (empty($messagepass)) {
                        $message['err_messagepass'] = "The message should not be blank...!";
                    }
                    ...
                    if (empty($message)) {
                        ...
                        $db = dbconn();
                        $sql = "INSERT INTO tbl_message(message_persons_name,message_email,message_message)VALUES('$Name','$Email','$messagepass')";
                        $db->query($sql);

                        // Display successfully added! message //
                        echo '<div id="liveAlertPlaceholder"><div></div><div><div class="alert alert-success alert-dismissible" role="alert">   <div>The message has been send !</div>  </div></div><div></div></div>';
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <input type="text" placeholder="Your name" id="Name" name="Name" value="<?= @$Name ?>">
                            <div class="text-danger"><?= @$message['err_name'] ?></div>  <!-- error message -->
                        </div>


                        <div class="col-lg-6 col-md-6">
                            <input type="text" placeholder="Your Email" id="Email" name="Email" value="<?= @$Email ?>">
                        ...
                        <div class="col-lg-12 text-center">
                            <textarea placeholder="Your message" id="messagepass" name="messagepass" rows="3"><?= isset($messagepass) ? $messagepass : '' ?></textarea>
                            <div class="text-danger"><?= isset($message['err_messagepass']) ? $message['err_messagepass'] : '' ?></div>
